var attachDate =
function () {
	var DATEPICKER_FORMAT = 'd-m-yyyy'; // for this format see the parseDate function below. Must be analogous to the DATE_FORMAT.
	var TIMEPICKER_FORMAT = 'g:ia';
	var DATE_FORMAT = 'j-n-Y'; // for this format see http://php.net/manual/function.date.php . Must be analogous to the DATEPICKER_FORMAT.
